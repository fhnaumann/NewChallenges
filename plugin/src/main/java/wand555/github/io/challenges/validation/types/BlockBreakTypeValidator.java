...
public abstract class BlockBreakTypeValidator extends CodeableValidator<MaterialJSON, Material> {

    public BlockBreakTypeValidator(List<MaterialJSON> dataSource) {
        super(dataSource);
    }
