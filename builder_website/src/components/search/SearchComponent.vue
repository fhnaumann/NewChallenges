<template>
  <div>
    ...
    <div>
      <DataView :value="((getPartialMatches !== undefined ? getPartialMatches() : []))" paginator :rows="5" data-key="criteriaKey">
...
<script setup lang="ts">
  import DataView, { type DataViewProps } from 'primevue/dataview'
  ...
  onMounted(() => {
    (dialogSearchText.value! as any).$el.focus()
